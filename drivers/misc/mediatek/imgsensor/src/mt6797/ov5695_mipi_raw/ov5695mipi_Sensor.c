...
static imgsensor_info_struct imgsensor_info = { 
	...
	.checksum_value = 0x1ca6b83a,//0xeb6b65f9, 0x523c51f6,		//checksum value for Camera Auto Test
...
//;mipi_datarate per lane: 840Mbps				  
    ...
    write_cmos_sensor(0x380e, 0x08);
    write_cmos_sensor(0x380f, 0xb8);
    write_cmos_sensor(0x3811, 0x02);//0x06, modified by Nick Zhang D160106
    write_cmos_sensor(0x3813, 0x06);
    write_cmos_sensor(0x3814, 0x03);
    write_cmos_sensor(0x3816, 0x03);
    write_cmos_sensor(0x3817, 0x01);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) { //15fps for PIP
		...
		write_cmos_sensor(0x3811, 0x16);//0x06, modified by Nick Zhang D160106
